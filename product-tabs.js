  ...
  const productData = {
    ...
    chatway: {
      ...
      agents: [
        ...
        {id:"glossary",name:"Glossary Agent",role:"Support glossary publisher",initials:"GL",status:"standby",color:"#e9e2f2",ink:"#5d4378",task:"Creates plain-English glossary entries for live chat, support, helpdesk, ecommerce, SaaS, and customer experience.",owner:"Chatway Content & SEO",cadence:"Daily + on demand",priority:"Medium",activities:[]},
