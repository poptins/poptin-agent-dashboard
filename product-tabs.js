      ...
      agents: [
        {
          ...
          instructions: ["Research a useful, non-duplicate topic for WordPress site owners using Premio products.","Write an original 2,000-3,000 word SEO, GEO, and AEO article using trustworthy non-competitor sources.","Use descriptive HTML links only, remove utm_source=openai, and block raw URLs or visible Markdown links.","Choose one existing WordPress category and attach 3-6 relevant tags.","Add an answer summary, 4-6 key takeaways, and direct FAQ answers.","Audit the complete rendered article before and after publishing."],
          activities: [{type:"scheduled",title:"Check the next Premio SEO article window",detail:"Check daily and publish a validated article when the 4-5 day cadence is due.",date:"2026-07-28T08:00:00+03:00",scheduleUtc:"05:00",url:"https://github.com/poptins/premio-agents/actions/workflows/seo-agent.yml",assetLabel:"Open SEO workflow"}]
        },
        {
